          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
            ...
            >
              <div className="relative">
                ...
                <motion.div
                  className="absolute -top-4 -right-4 p-3 rounded-full bg-blue-600 text-white shadow-lg"
                  whileHover={{ scale: 1.2, rotate: 10 }}
                >
                  <FaCode size={16} />
                </motion.div>
                <motion.div
                  className="absolute -bottom-4 -left-4 p-3 rounded-full bg-purple-600 text-white shadow-lg"
                  whileHover={{ scale: 1.2, rotate: -10 }}
                >
                  <FaRocket size={16} />
                </motion.div>

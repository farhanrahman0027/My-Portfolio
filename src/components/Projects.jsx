...
const Projects = () => {
  ...
  const projects = [
    {
      id: 1,
      title: "Madhubani Medical College & Hospital",
      subtitle: "Healthcare & Educational Website",
      description:
        "A professional website for Madhubani Medical College & Hospital, showcasing academic programs, hospital services, admissions, and faculty details.",
      details: [
        "Developed responsive and visually engaging frontend for seamless user experience",
        "Integrated admission enquiry form with validation",
        "Showcased academic, hospital, and faculty information with clean layouts",
        "Optimized performance for fast load times across devices",
      ],
